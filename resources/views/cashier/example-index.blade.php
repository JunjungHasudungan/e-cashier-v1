                                            ...
                                            <div class="px-5 pb-5">
                                                ...
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <button
                                                        ...
                                                        :disabled="productInChart(product.id)"
                                                        :class="productInChart(product.id)
                                                        ? 'bg-gray-400 cursor-not-allowed'
                                                        : 'bg-blue-700 hover:bg-blue-800'"

                                                        type="button"
                                                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                        <span x-text="productInChart(product.id) ? 'Added' : 'Add to cart'"></span>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <template x-if="listProductOnChart.length > 0">
                                                <template x-for="(product, index) in listProductOnChart" :key="product.id">
                                                    <tr class="bg-white dark:bg-gray-800">
                                                        ...
                                                        <td class="px-6 py-3">
                                                            <svg @click="removeProductFromChart(product.id)" xmlns="http://www.w3.org/2000/svg" fill="red" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="cursor-pointer size-4">
