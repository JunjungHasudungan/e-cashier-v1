                                                ...
                                                <tr class="font-semibold text-gray-900 dark:text-white">
                                                    ...
                                                    <td class="px-6 py-3">
                                                       <input
                                                        ...
                                                        <template x-if="messageError">
                                                            <p x-text="messageError" class="mt-2.5 text-sm text-red-300"></p>
                                                        </template>
                                                        </td>
                                                    <td class="px-3 py-3 flex">
                                                        <button
                                                            type="button"
                                                            x-on:click="payNow()"
                                                            {{-- melakukan binding atau mengikat ke disable --}}
                                                            x-bind:disabled="onProcessCalculate"
                                                            x-show="dataOrderProduct.amount"
                                                            class="p-2 w-full flex gap-2 item-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-thin rounded-lg text-sm px-1 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">

                                                            {{-- spinner --}}
                                                            <svg x-show="onProcessCalculate" aria-hidden="true" role="status" class="w-4 h-4 me-2 text-fg-brand animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <span x-text="onProcessCalculate ? 'Process...' : 'Pay now' "></span>
                                                        </button>
                                                    </td>
                                                </tr>
                                            </tfoot>
